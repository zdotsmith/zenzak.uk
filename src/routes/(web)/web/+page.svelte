...
class="hero-section relative h-screen overflow-hidden flex items-center justify-center"
>
...
<div class="hero-content text-center z-10" style="opacity: {1 - heroProgress};">
<h1 class="text-6xl font-semibold text-white mb-6">
...
<div class="section-content flex items-center justify-center h-full z-10">
<div class="text-center">
<h2 class="text-4xl font-semibold text-white mb-4">
Entering the Digital Gallery
</h2>
...
A 3D model showcasing the future of product visualization. 
Interactive elements reveal hidden details and specifications.
</p>
...
<section class="svg-interlude bg-black py-20 overflow-hidden">
...
<h3 class="text-4xl font-semibold text-white mb-6">
Architectural Visualization
</h3>
<p class="text-lg text-white/70 max-w-3xl mx-auto">
Experience spaces before they exist. Interactive lighting controls 
and material selection bring architectural concepts to life.
</p>
</div>

<div class="architecture-container">
<!-- 3D Building Placeholder -->
<div class="building-3d" class:day={lightingMode === 'day'} class:sunset={lightingMode === 'sunset'} class:night={lightingMode === 'night'}>
...
<button class="control-btn" class:active={lightingMode === 'day'} on:click={() => setLighting('day')}>Day</button>
<button class="control-btn" class:active={lightingMode === 'sunset'} on:click={() => setLighting('sunset')}>Sunset</button>
<button class="control-btn" class:active={lightingMode === 'night'} on:click={() => setLighting('night')}>Night</button>
</div>
</div>
</div>
</section>
...
<!-- Process Steps -->
<div class="process-steps grid md:grid-cols-3 gap-8 mt-12">
<div class="process-step text-center">
<div class="step-icon w-16 h-16 mx-auto mb-4 bg-blue-500/20 rounded-full flex items-center justify-center">
<svg class="w-8 h-8 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
<path d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm12 4l-6 4-6-4V6l6 4 6-4v2z"/>
</svg>
</div>
<h4 class="text-xl font-semibold text-white mb-2">Design</h4>
<p class="text-white/60">3D modeling and conceptualization</p>
</div>

<div class="process-step text-center">
<div class="step-icon w-16 h-16 mx-auto mb-4 bg-purple-500/20 rounded-full flex items-center justify-center">
<svg class="w-8 h-8 text-purple-400" fill="currentColor" viewBox="0 0 20 20">
<path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"/>
</svg>
</div>
<h4 class="text-xl font-semibold text-white mb-2">Develop</h4>
<p class="text-white/60">Web integration and optimization</p>
</div>

<div class="process-step text-center">
<div class="step-icon w-16 h-16 mx-auto mb-4 bg-green-500/20 rounded-full flex items-center justify-center">
<svg class="w-8 h-8 text-green-400" fill="currentColor" viewBox="0 0 20 20">
<path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
</svg>
</div>
<h4 class="text-xl font-semibold text-white mb-2">Deploy</h4>
...
class="w-full p-4 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:border-blue-400 focus:outline-none"
>
<input 
type="email" 
...
rows="4"
class="w-full p-4 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:border-blue-400 focus:outline-none resize-none"
></textarea>
<button class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-6 rounded-lg transition-colors">
Start Your Journey
</button>
</div>
</div>
...
.crystal-face-1 { transform: rotateY(0deg) translateZ(100px); }
.crystal-face-2 { transform: rotateY(90deg) translateZ(100px); }
.crystal-face-3 { transform: rotateY(180deg) translateZ(100px); }
.crystal-face-4 { transform: rotateY(270deg) translateZ(100px); }
...
50% { transform: skew(-15deg) translateX(20px); }
}
...
to { box-shadow: 0 0 40px #8b5cf6, 0 0 60px #06b6d4; }
}
...
.building-floor-1 { bottom: 0; }
.building-floor-2 { bottom: 60px; }
.building-floor-3 { bottom: 120px; }
